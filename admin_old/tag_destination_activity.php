        ...
        $("#grid_dash_th").jqxGrid(
                {
                    ...
                    rowsheight: 34,
                    columns: [
                        {text: 'Destination Activity Id', dataField: 'destination_activity_tag_list_id', align: 'center', minwidth: 64, width: '20%'},
                        {text: 'Destination Activity Tag', dataField: 'destination_activity_tag', align: 'center', minwidth: 74.5, width: '80%'}
                    ]
                });
