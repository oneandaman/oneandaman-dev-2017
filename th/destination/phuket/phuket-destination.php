...
$destination_details_80 = str_replace("\'", "'", $row['destination_details_80']);
$destination_details_200 = str_replace("\'", "'", $row['destination_details_200']);
$destination_details_long = str_replace("\'", "'", $row['destination_details_long']);
...
$destination_content_ref_1 = $row['destination_content_ref_1'];
$destination_content_ref_2 = $row['destination_content_ref_2'];
$destination_content_ref_3 = $row['destination_content_ref_3'];
$destination_content_ref_4 = $row['destination_content_ref_4'];
$destination_content_ref_5 = $row['destination_content_ref_5'];
...
//Get Destination Type Tag
$count_destination_type_tag = count_record("destination_type_tag", "destination_id ='" . $dID . "'");
if ($count_destination_type_tag > 0)
{
    $query_type_tag = "SELECT b.destination_type_tag as destination_type_tag, a.destination_id , b.destination_type_tag_list_id FROM destination_type_tag AS a 
LEFT JOIN destination_type_tag_list AS b ON a.destination_type_tag = b.destination_type_tag_list_id WHERE a.destination_id = '" . $dID . "'";

    $type_tag = query_all($query_type_tag);
}
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row text-left ml5 mr5">
                            ...
                            <div class="text-right content-ref">
                                <?php
                                if (trim($destination_content_ref_1) != '' && trim($destination_content_ref_1) != 'NULL')
                                {
                                    ?>
                                    <a href="<?php echo $destination_content_ref_1; ?>" target="_blank" rel="nofollow"><?php echo $destination_content_ref_1; ?></a><br />
                                    <?php
                                }
                                if (trim($destination_content_ref_2) != '' && trim($destination_content_ref_2) != 'NULL')
                                {
                                    ?>
                                    <a href="<?php echo $destination_content_ref_2; ?>" target="_blank" rel="nofollow"><?php echo $destination_content_ref_2; ?></a><br />
                                    <?php
                                }
                                if (trim($destination_content_ref_3) != '' && trim($destination_content_ref_3) != 'NULL')
                                {
                                    ?>
                                    <a href="<?php echo $destination_content_ref_3; ?>" target="_blank" rel="nofollow"><?php echo $destination_content_ref_3; ?></a><br />
                                    <?php
                                }
                                if (trim($destination_content_ref_4) != '' && trim($destination_content_ref_4) != 'NULL')
                                {
                                    ?>
                                    <a href="<?php echo $destination_content_ref_4; ?>" target="_blank" rel="nofollow"><?php echo $destination_content_ref_4; ?></a><br />
                                    <?php
                                }
                                if (trim($destination_content_ref_5) != '' && trim($destination_content_ref_5) != 'NULL')
                                {
                                    ?>
                                    <a href="<?php echo $destination_content_ref_5; ?>" target="_blank" rel="nofollow"><?php echo $destination_content_ref_5; ?></a><br />
                                    <?php
                                }
                        ...
                        <div id="tag-container" class="row pr10 pl10 clearfix">
                            ...
                            <ul class="tag">
                                ...
                                {
                                    $i = 0;
                                    while ($i < count($type_tag))
                                    {
                                        $dt = $type_tag[$i];
                                        ?>
                                        <li><a href=""><?php echo $dt['destination_type_tag']; ?></a></li>
                                        <?php
                                        $i++;
                                    }
                                }
                    ...
                    <div id="sidebar" class="col-md-4 pl15">  
                        ...
                        <div class="pr10 pl10 pb25 clearfix">
                            ...
                            <div id="local-info">
                                ...
                                <div class="pl25 infor-text"><?php echo is_null($destination_fee) ? "-" : str_replace("|", "<br>", $destination_fee); ?></div>
                                <br>
                        ...
                        <div class="pr10 pl10 pb25 clearfix">
                            ...
                            <div id="contact-info">
                                ...
                                <div class="pl25 infor-text">
                                    <?php
                                    if (is_null($destination_info_website))
                                    {
                                        echo "-";
                                    }
                                    else
                                ...
                                <br>
                                <?php
                                if (!is_null($destination_social_facebook) || !is_null($destination_social_instragram) || !is_null($destination_social_youtube))
                                {
                                    ?>
