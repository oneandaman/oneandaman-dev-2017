    ...
    else
    {
        ...
        <div id='jqxTabs'>
            ...
            <div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-5 text-left"><div id="restaurant_status_th" ></div></div> 
                        <div class="col-sm-5 text-left">*สถานะของร้าน (enable/disable)</div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-5 text-left"><input type="text" id="restaurant_geo_x_th" /></div> 
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-5 text-left"><input type="text" id="restaurant_geo_y_th" /></div> 
                        <div class="col-sm-5 text-left"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">ประเภทร้านอาหาร </div> 
                        <div class="col-sm-5 text-left"><div id='restaurant_cat_th'></div></div> 
                        <div class="col-sm-5 text-left">*</div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-5 text-left"><input type="text" id="restaurant_name_th" /></div> 
                        <div class="col-sm-5 text-left">*</div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-5 text-left"><input type="text" id="restaurant_address_th" /></div> 
                        <div class="col-sm-5 text-left">*</div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-5 text-left"><div id='restaurant_province_id_th'></div></div> 
                        <div class="col-sm-5 text-left">*</div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-5 text-left"><div id='restaurant_district_id_th'></div></div> 
                        <div class="col-sm-5 text-left">*</div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-5 text-left"><textarea id="restaurant_details_80_th"></textarea></div> 
                        <div class="col-sm-5 text-left"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-5 text-left"><textarea id="restaurant_details_200_th"></textarea></div>
                        <div class="col-sm-5 text-left"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-5 text-left"><textarea id="restaurant_details_long_th"></textarea></div> 
                        <div class="col-sm-5 text-left"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-5 text-left"><input type="text" id="restaurant_open_hour_th"></div> 
                        <div class="col-sm-5 text-left"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-5 text-left"><input type="text" id="restaurant_info_tel_th"></div> 
                        <div class="col-sm-5 text-left">(หากมีมากกว่า 1 ให้ใช้เครื่องหมาย | เป็นตัวคั่น และใช้รูปแบบ +66(0) 99999 9999 เช่น +66 2623 5500 ext.3100|+66(0) 83994 3565 เป็นต้น)</div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-5 text-left"><input type="text" id="restaurant_info_website_th"></div> 
                        <div class="col-sm-5 text-left"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-5 text-left"><input type="text" id="restaurant_info_email_th"></div> 
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-5 text-left"><input type="text" id="restaurant_social_facebook_th"></div> 
                        <div class="col-sm-5 text-left"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-5 text-left"><input type="text" id="restaurant_social_instragram_th"></div> 
                        <div class="col-sm-5 text-left"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-5 text-left"><input type="text" id="restaurant_social_youtube_th"></div> 
                        <div class="col-sm-5 text-left"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-5 text-left"><input type="text" id="restaurant_review_ref_short_th"></div> 
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-5 text-left"><input type="text" id="restaurant_review_ref_long_th"></div> 
            ...
            <div> <!-- English Tab-->
                <div class="row">
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">สถานะ</div> 
                        <div class="col-sm-5 text-left"><div id="restaurant_status_eng" ></div></div> 
                        <div class="col-sm-5 text-left">*สถานะของร้าน (enable/disable)</div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">ละติจูด</div> 
                        <div class="col-sm-5 text-left"><input type="text" id="restaurant_geo_x_eng" /></div> 
                        <div class="col-sm-5 text-left"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">ลองติจูด</div> 
                        <div class="col-sm-5 text-left"><input type="text" id="restaurant_geo_y_eng" /></div> 
                        <div class="col-sm-5 text-left"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">ประเภทร้านอาหาร</div> 
                        <div class="col-sm-5 text-left"><div id='restaurant_cat_eng'></div></div> 
                        <div class="col-sm-5 text-left">*</div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">ชื่อสถานที่</div> 
                        <div class="col-sm-5 text-left"><input type="text" id="restaurant_name_eng" /></div> 
                        <div class="col-sm-5 text-left">*</div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">ที่อยู่</div> 
                        <div class="col-sm-5 text-left"><input type="text" id="restaurant_address_eng" /></div> 
                        <div class="col-sm-5 text-left">*</div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">จังหวัด</div> 
                        <div class="col-sm-5 text-left"><div id='restaurant_province_id_eng'></div></div> 
                        <div class="col-sm-5 text-left">*</div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">อำเภอ</div> 
                        <div class="col-sm-5 text-left"><div id='restaurant_district_id_eng'></div></div> 
                        <div class="col-sm-5 text-left">*</div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">รายละเอียด (80 ตัวอักษร)</div> 
                        <div class="col-sm-5 text-left"><textarea id="restaurant_details_80_eng"></textarea></div> 
                        <div class="col-sm-5 text-left"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">รายละเอียด (200 ตัวอักษร)</div> 
                        <div class="col-sm-5 text-left"><textarea id="restaurant_details_200_eng"></textarea></div> 
                        <div class="col-sm-5 text-left"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">คำอธิบาย</div> 
                        <div class="col-sm-5 text-left"><textarea id="restaurant_details_long_eng"></textarea></div> 
                        <div class="col-sm-5 text-left"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">เวลาเปิด-ปิด</div> 
                        <div class="col-sm-5 text-left"><input type="text" id="restaurant_open_hour_eng"></div> 
                        <div class="col-sm-5 text-left"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">เบอร์โทร</div> 
                        <div class="col-sm-5 text-left"><input type="text" id="restaurant_info_tel_eng"></div> 
                        <div class="col-sm-5 text-left">(หากมีมากกว่า 1 ให้ใช้เครื่องหมาย | เป็นตัวคั่น และใช้รูปแบบ +66(0) 99999 9999 เช่น +66 2623 5500 ext.3100|+66(0) 83994 3565 เป็นต้น)</div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">เว็บไซต์</div> 
                        <div class="col-sm-5 text-left"><input type="text" id="restaurant_info_website_eng"></div> 
                        <div class="col-sm-5 text-left"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">อีเมล</div> 
                        <div class="col-sm-5 text-left"><input type="text" id="restaurant_info_email_eng"></div> 
                        <div class="col-sm-5 text-left">(หากมีมากกว่า 1 ให้ใช้เครื่องหมาย | เป็นตัวคั่น)</div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">เพจเฟสบุ๊ค</div> 
                        <div class="col-sm-5 text-left"><input type="text" id="restaurant_social_facebook_eng"></div> 
                        <div class="col-sm-5 text-left"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">อินสตาแกรม</div> 
                        <div class="col-sm-5 text-left"><input type="text" id="restaurant_social_instragram_eng"></div> 
                        <div class="col-sm-5 text-left"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">ยูทูป</div> 
                        <div class="col-sm-5 text-left"><input type="text" id="restaurant_social_youtube_eng"></div> 
                        <div class="col-sm-5 text-left"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">อ้างอิงเนื่อหา (สั้น)</div> 
                        <div class="col-sm-5 text-left"><input type="text" id="restaurant_review_ref_short_eng"></div> 
                        <div class="col-sm-5 text-left">Link ที่มาสั้นๆสำหรับแสดงผลหน้าเว็บไซต์ (หากมีมากกว่า 1 ให้ใช้เครื่องหมาย | เป็นตัวคั่น)</div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">อ้างอิงเนื่อหา (ยาว)</div> 
                        <div class="col-sm-5 text-left"><input type="text" id="restaurant_review_ref_long_eng"></div> 
                        <div class="col-sm-5 text-left">Link เต็ม สำหรับไปยังหน้าเว็บไซต์นั้นๆ (หากมีมากกว่า 1 ให้ใช้เครื่องหมาย | เป็นตัวคั่น)</div>
                    </div>
                </div>
        ...
        <script type="text/javascript">
            $(document).ready(function ()
            {
                ...
                $("#restaurant_status_th").jqxDropDownList({source: restaurant_status_th_source,displayMember:'text_status', valueMember:'value_status',  selectedIndex: 0, itemHeight: 30, width: '100%', height: 30, autoDropDownHeight: true, theme: theme});
                ...
                $("#restaurant_status_eng").jqxDropDownList({source: restaurant_status_eng_source,displayMember:'text_status', valueMember:'value_status', selectedIndex: 0, itemHeight: 30, width: '100%', height: 30, autoDropDownHeight: true, theme: theme});
                                ...
                                data:
                                        {
                                            fc: 'save_restaurant',
                                            lag: 'en',
                                            restaurant_district_id: $('#restaurant_district_id_eng').val(),
                                            restaurant_province_id: $('#restaurant_province_id_eng').val(),
                                            restaurant_status: $('#restaurant_status_eng').val(),
                                            restaurant_geo_x: $('#restaurant_geo_x_eng').val(),
                                            restaurant_geo_y: $('#restaurant_geo_y_eng').val(),
                                            restaurant_info_tel: $('#restaurant_info_tel_eng').val(),
                                            restaurant_info_website: $('#restaurant_info_website_eng').val(),
                                            restaurant_info_email: $('#restaurant_info_email_eng').val(),
                                            restaurant_social_facebook: $('#restaurant_social_facebook_eng').val(),
                                            restaurant_social_instragram: $('#restaurant_social_instragram_eng').val(),
                                            restaurant_social_youtube: $('#restaurant_social_youtube_eng').val(),
                                            restaurant_cat: $('#restaurant_cat_eng').val(),
                                            restaurant_name: $('#restaurant_name_eng').val(),
                                            restaurant_address: $('#restaurant_address_eng').val(),
                                            restaurant_details_80: $('#restaurant_details_80_eng').val(),
                                            restaurant_details_200: $('#restaurant_details_200_eng').val(),
                                            restaurant_details_long: $('#restaurant_details_long_eng').val(),
                                            restaurant_open_hour: $('#restaurant_open_hour_eng').val(),
                                            restaurant_review_ref_short: $('#restaurant_review_ref_short_eng').val(),
                                            restaurant_review_ref_long: $('#restaurant_review_ref_long_eng').val()
                                        }
                            })
                            .done(function (msg)
                            {
