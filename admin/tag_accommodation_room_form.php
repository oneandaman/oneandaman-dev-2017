...
<div id='jqxTabs'>
    ...
    <div>
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="col-sm-6 text-left"><input type="text" id="accommodation_room_tag_th" /></div>
    ...
    <div><!-- English Tab -->
        <div class="row">
            <div class="col-sm-12">
                <div class="col-sm-3 text-left">ประเภทห้องพัก</div>
                <div class="col-sm-6 text-left"><input type="text" id="accommodation_room_tag_eng" /></div>
                <div class="col-sm-3 text-left">*</div>
            </div>
        </div>
        <div class="row">
