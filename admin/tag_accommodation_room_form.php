    ...
    else
    {
        ...
        <div id='jqxTabs'>
            ...
            <div>
                <div class="row">
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">ประเภทห้องพัก</div>
                        <div class="col-sm-5 text-left"><input type="text" id="accommodation_room_tag_th" /></div>
            ...
            <div><!-- English Tab -->
                <div class="row">
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">ประเภทห้องพัก</div>
                        <div class="col-sm-5 text-left"><input type="text" id="accommodation_room_tag_eng" /></div>
                        <div class="col-sm-5 text-left">*</div>
                    </div>
                </div>
                <div class="row">
        ...
        <script type="text/javascript">
            $(document).ready(function ()
            {
                ...
                $("#accommodation_room_tag_th").jqxInput({height: 25, width: '98%', minLength: 1});
                $("#accommodation_room_tag_eng").jqxInput({height: 25, width: '98%', minLength: 1});
