        ...
        $("#grid_dash_th").jqxGrid(
                {
                    ...
                    rowsheight: 34,
                    columns: [
                        {text: 'รหัส', dataField: 'accommodation_type_tag_list_id', align: 'center', cellsalign: 'center' ,  minwidth: 64, width: '20%'},
                        {text: 'รายละเอียด', dataField: 'accommodation_type_tag', align: 'center', minwidth: 74.5, width: '80%'}
                    ]
                });
