...
<ol class="breadcrumb">
    <li><a href="#">Home</a></li>
    <li class="active">Accommodation Type Tag</li>
</ol>
<?php
...
<script type="text/javascript">
    $(document).ready(function ()
    {
        ...
        $("#grid_dash_th").jqxGrid(
                {
                    ...
                    rowsheight: 34,
                    columns: [
                        {text: 'Accommodation Id', dataField: 'accommodation_type_tag_list_id', align: 'center', minwidth: 64, width: '20%'},
                        {text: 'Accommodation Type Tag', dataField: 'accommodation_type_tag', align: 'center', minwidth: 74.5, width: '80%'}
                    ]
                });
        ...
        {
            window.open("tag_accommodation_type_form.php", "_self");
        });
        // จบใส่ javascript
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    });
