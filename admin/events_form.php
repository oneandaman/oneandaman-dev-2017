    ...
    else
    {
        ...
        <div id='jqxTabs'>
            ...
            <div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">ชื่อกิจกรรม</div>
                        <div class="col-sm-5 text-left"><input type="text" id="event_name_th" /></div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">รายละเอียดกิจกรรม</div>
                        <div class="col-sm-5 text-left"><textarea id="event_detail_th"></textarea></div>
                        <div class="col-sm-5 text-left"></div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-5 text-left"><input type="text" id="event_info_link_short_th"></div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-5 text-left"><input type="text" id="event_info_link_long_th"></div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">สถานที่จัดงาน</div>
                        <div class="col-sm-5 text-left"><input type="text" id="event_venue_th"></div>
                        <div class="col-sm-5 text-left">*</div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-5 text-left"><div id='event_venue_province_id_th'></div></div>
                        <div class="col-sm-5 text-left">*</div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-5 text-left"><div id='event_venue_district_id_th'></div></div>
                        <div class="col-sm-5 text-left">*</div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-5 text-left"><input type="text" id="event_geo_x_th" /></div>
                        <div class="col-sm-5 text-left"></div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-5 text-left"><input type="text" id="event_geo_y_th" /></div>
                        <div class="col-sm-5 text-left"></div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">วันที่เริ่มกิจกรรม</div>
                        <div class="col-sm-5 text-left"><div id="event_start_date_th"></div></div>
                        <div class="col-sm-5 text-left">*</div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">วันที่สิ้นสุดกิจกรรม</div>
                        <div class="col-sm-5 text-left"><div id="event_end_date_th"></div></div>
                        <div class="col-sm-5 text-left">*</div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-5 text-left"><div id="event_file_saved_name_th"></div></div>
                        <div class="col-sm-5 text-left"></div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-5 text-left"><input type="text" id="event_pic_alt_th"></div>
                        <div class="col-sm-5 text-left"></div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-5 text-left"><textarea id="event_pic_detail_th"></textarea></div>
                        <div class="col-sm-5 text-left"></div>
                    </div>
            ...
            <div><!-- English Tab -->
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">ชื่อกิจกรรม</div>
                        <div class="col-sm-5 text-left"><input type="text" id="event_name_eng" /></div>
                        <div class="col-sm-5 text-left">*</div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">รายละเอียดกิจกรรม</div>
                        <div class="col-sm-5 text-left"><textarea id="event_detail_eng"></textarea></div>
                        <div class="col-sm-5 text-left"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">อ้างอิงเนื่อหา (สั้น)</div> 
                        <div class="col-sm-5 text-left"><input type="text" id="event_info_link_short_eng"></div>
                        <div class="col-sm-5 text-left">Link ที่มาสั้นๆสำหรับแสดงผลหน้าเว็บไซต์ (หากมีมากกว่า 1 ให้ใช้เครื่องหมาย | เป็นตัวคั่น)</div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">อ้างอิงเนื่อหา (ยาว)</div> 
                        <div class="col-sm-5 text-left"><input type="text" id="event_info_link_long_eng"></div>
                        <div class="col-sm-5 text-left">Link เต็ม สำหรับไปยังหน้าเว็บไซต์นั้นๆ (หากมีมากกว่า 1 ให้ใช้เครื่องหมาย | เป็นตัวคั่น)</div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">สถานที่จัดงาน</div>
                        <div class="col-sm-5 text-left"><input type="text" id="event_venue_eng"></div>
                        <div class="col-sm-5 text-left">*</div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">จังหวัด</div>
                        <div class="col-sm-5 text-left"><div id='event_venue_province_id_eng'></div></div>
                        <div class="col-sm-5 text-left">*</div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">อำเภอ</div>
                        <div class="col-sm-5 text-left"><div id='event_venue_district_id_eng'></div></div>
                        <div class="col-sm-5 text-left">*</div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">ละติจูด</div>
                        <div class="col-sm-5 text-left"><input type="text" id="event_geo_x_eng" /></div>
                        <div class="col-sm-5 text-left"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">ลองติจูด</div>
                        <div class="col-sm-5 text-left"><input type="text" id="event_geo_y_eng" /></div>
                        <div class="col-sm-5 text-left"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">วันที่เริ่มกิจกรรม</div>
                        <div class="col-sm-5 text-left"><div id="event_start_date_eng"></div></div>
                        <div class="col-sm-5 text-left">*</div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">วันที่สิ้นสุดกิจกรรม</div>
                        <div class="col-sm-5 text-left"><div id="event_end_date_eng"></div> </div>
                        <div class="col-sm-5 text-left">*</div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">อัพโหลดรูปภาพ</div>
                        <div class="col-sm-5 text-left"><div id="event_file_saved_name_eng"></div></div>
                        <div class="col-sm-5 text-left"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">ชื่อรูปภาพ</div>
                        <div class="col-sm-5 text-left"><input type="text" id="event_pic_alt_eng"></div>
                        <div class="col-sm-5 text-left"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2 text-left">คำอธิบายรูปภาพ</div>
                        <div class="col-sm-5 text-left"><textarea id="event_pic_detail_eng"></textarea></div>
                        <div class="col-sm-5 text-left"></div>
                    </div>
                </div>
                <div class="row">
