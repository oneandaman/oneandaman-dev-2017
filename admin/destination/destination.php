                ...
                $("#grid_dash").jqxGrid(
                        {
                            ...
                            rowsheight: 34,
                            columns: [
                                {text: 'Name', dataField: 'destination_name', align: 'center', minwidth: 64, width: '30%'},
                                {text: 'Status', dataField: 'destination_status', align: 'center', minwidth: 74.5, width: '15%'},
                                {text: 'Travel Route', dataField: 'destination_route_cat', align: 'center', minwidth: 74.5, width: '25%'},
                                {text: 'District', dataField: 'destination_district', align: 'center', minwidth: 64, width: '15%'},
                                {text: 'Province', dataField: 'destination_province', align: 'center', minwidth: 64, width: '15%'}
                            ]
                        });
