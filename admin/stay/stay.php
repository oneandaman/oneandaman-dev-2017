    ...
    <body>
        <section class="content">
            ...
            <div class="row">
                ...
                <div class="col-sm-2"></div>
                <div class="col-sm-2"></div>
                <div class="col-sm-2"><input type="text" id="stay_name_search" /></div>
        ...
        <script type="text/javascript">
            $(document).ready(function ()
            {
                ...
                $("#stay_name_search").jqxInput({placeHolder: "Search by Name", height: 25, width: 200, minLength: 1});
                // prepare the data
                var data = null;
                var source =
                        {
                ...
                $("#grid_dash").jqxGrid(
                        {
                            ...
                            rowsheight: 34,
                            columns: [
                                {text: 'Name', dataField: 'stay_name', align: 'center', minwidth: 64, width: '30%'},
                                {text: 'Status', dataField: 'stay_status', align: 'center', minwidth: 74.5, width: '15%'},
                                {text: 'Travel Route', dataField: 'stay_route_cat', align: 'center', minwidth: 74.5, width: '25%'},
                                {text: 'District', dataField: 'stay_district', align: 'center', minwidth: 64, width: '15%'},
                                {text: 'Province', dataField: 'stay_province', align: 'center', minwidth: 64, width: '15%'}
                            ]
                        });
