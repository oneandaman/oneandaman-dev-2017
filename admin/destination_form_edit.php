          ...
          function save_to_db(lang)
            {
              ...
              var url = "database/query.php";
               ...
               //=========== TH ===============
                var source_th =
                        {
                            ...
                            datafields: [
                                ...
                                {name: 'destination_geo_x'},
                                {name: 'destination_geo_y'},
                                {name: 'destination_info_tel'},
                                {name: 'destination_info_fax'},
                                {name: 'destination_info_email'},
                                {name: 'destination_info_website'},
                                {name: 'destination_social_facebook'},
                                {name: 'destination_social_instragram'},
                                {name: 'destination_social_youtube'},
                                {name: 'destination_cat'},
                                {name: 'destination_name'},
                                {name: 'destination_address'},
                                {name: 'destination_details_80'},
                                {name: 'destination_details_200'},
                                {name: 'destination_details_long'},
                                {name: 'destination_open_hour'},
                                {name: 'destination_fee'},
                                {name: 'destination_visit_season'},
                                {name: 'destination_content_ref_1'},
                                {name: 'destination_content_ref_2'},
                                {name: 'destination_content_ref_3'},
                                {name: 'destination_content_ref_4'},
                                {name: 'destination_content_ref_5'},
                ...
                var dataAdapter_th = new $.jqx.dataAdapter(source_th,
                        {
                            loadComplete: function (records)
                            {
                                // get data records.
                                var records_th = dataAdapter_th.records;
                                // หรือถ้าไม่ต้องการใช้ loop records[0].calories;

                                $('#destination_district_id_th').val(records_th[0].destination_district_id);
                                $('#destination_province_id_th').val(records_th[0].destination_province_id);
                                $('#destination_status_th').val(records_th[0].destination_status);
                                $('#destination_geo_x_th').val(records_th[0].destination_geo_x);
                                $('#destination_geo_y_th').val(records_th[0].destination_geo_y);
                                $('#destination_info_tel_th').val(records_th[0].destination_info_tel);
                                $('#destination_info_fax_th').val(records_th[0].destination_info_fax);
                                $('#destination_info_email_th').val(records_th[0].destination_info_email);
                                $('#destination_info_website_th').val(records_th[0].destination_info_website);
                                $('#destination_social_facebook_th').val(records_th[0].destination_social_facebook);
                                $('#destination_social_instragram_th').val(records_th[0].destination_social_instragram);
                                $('#destination_social_youtube_th').val(records_th[0].destination_social_youtube);
                                $('#destination_cat_th').val(records_th[0].destination_cat);
                                $('#destination_name_th').val(records_th[0].destination_name);
                                $('#destination_address_th').val(records_th[0].destination_address);
                                $('#destination_details_80_th').val(records_th[0].destination_details_80);
                                $('#destination_details_200_th').val(records_th[0].destination_details_200);
                                $('#destination_details_long_th').val(records_th[0].destination_details_long);
                                $('#destination_open_hour_th').val(records_th[0].destination_open_hour);
                                $('#destination_fee_th').val(records_th[0].destination_fee);
                                $('#destination_visit_season_th').val(records_th[0].destination_visit_season);
                                $('#destination_content_ref_1_th').val(records_th[0].destination_content_ref_1);
                                $('#destination_content_ref_2_th').val(records_th[0].destination_content_ref_2);
                                $('#destination_content_ref_3_th').val(records_th[0].destination_content_ref_3);
                                $('#destination_content_ref_4_th').val(records_th[0].destination_content_ref_4);
                                $('#destination_content_ref_5_th').val(records_th[0].destination_content_ref_5);
                                $('#destination_update_th').val(records_th[0].destination_update);
                                $('#destination_activity_th').val(records_th[0].destination_activity); 
                            },
                            loadError: function (jqXHR, status, error) {},
                            beforeLoadComplete: function (records) {}
                        });
                // perform data binding.
                dataAdapter_th.dataBind();
                //จบแบบ เก็บลง datasource
                ...
                var dataAdapter_en = new $.jqx.dataAdapter(source_en,
                        {
                            ...
                            {
                                // get data records.
                                var records_en = dataAdapter_en.records;
                                // หรือถ้าไม่ต้องการใช้ loop records[0].calories;

                                $('#destination_district_id_en').val(records_en[0].destination_district_id);
                                $('#destination_province_id_en').val(records_en[0].destination_province_id);
                                $('#destination_status_en').val(records_en[0].destination_status);
                                $('#destination_geo_x_en').val(records_en[0].destination_geo_x);
                                $('#destination_geo_y_en').val(records_en[0].destination_geo_y);
                                $('#destination_info_tel_en').val(records_en[0].destination_info_tel);
                                $('#destination_info_fax_en').val(records_en[0].destination_info_fax);
                                $('#destination_info_email_en').val(records_en[0].destination_info_email);
                                $('#destination_info_website_en').val(records_en[0].destination_info_website);
                                $('#destination_social_facebook_en').val(records_en[0].destination_social_facebook);
                                $('#destination_social_instragram_en').val(records_en[0].destination_social_instragram);
                                $('#destination_social_youtube_en').val(records_en[0].destination_social_youtube);
                                $('#destination_cat_en').val(records_en[0].destination_cat);
                                $('#destination_name_en').val(records_en[0].destination_name);
                                $('#destination_address_en').val(records_en[0].destination_address);
                                $('#destination_details_80_en').val(records_en[0].destination_details_80);
                                $('#destination_details_200_en').val(records_en[0].destination_details_200);
                                $('#destination_details_long_en').val(records_en[0].destination_details_long);
                                $('#destination_open_hour_en').val(records_en[0].destination_open_hour);
                                $('#destination_fee_en').val(records_en[0].destination_fee);
                                $('#destination_visit_season_en').val(records_en[0].destination_visit_season);
                                $('#destination_content_ref_1_en').val(records_en[0].destination_content_ref_1);
                                $('#destination_content_ref_2_en').val(records_en[0].destination_content_ref_2);
                                $('#destination_content_ref_3_en').val(records_en[0].destination_content_ref_3);
                                $('#destination_content_ref_4_en').val(records_en[0].destination_content_ref_4);
                                $('#destination_content_ref_5_en').val(records_en[0].destination_content_ref_5);
                                $('#destination_update_en').val(records_en[0].destination_update);
                                $('#destination_activity_en').val(records_en[0].destination_activity); 
                            },
                            loadError: function (jqXHR, status, error) {},
                            beforeLoadComplete: function (records) {}
                        });
                // perform data binding.
                dataAdapter_en.dataBind();
                //จบแบบ เก็บลง datasource
